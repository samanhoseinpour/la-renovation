...
- `/` — home: full-bleed viewport hero, a who-we-are intro, the seven divisions as a photo-card grid beside an intro rail that pins on desktop, a process strip, a Southern California coverage band, an auto-scrolling team marquee, an FAQ teaser and a closing CTA; the featured-projects and client-notes sections are gated off until real material lands (see Publish gates)
